...
VALUES
	(1,'KGF:Chapter 2',2022,'*8.2/10','In the blood-soaked Kolar Gold Fields, Rockys name strikes fear into his foes. While his allies look up to him, the government sees him as a threat to law and order.Rocky must battle threats from all sides for unchallenged supremacy.','assets/img/kgf2.jpg'),
	(2,'PUSHPA: The rise',2021,'*7.6/10','A manual labourer rises through the ranks of a smuggling syndicate, making some powerful enemies in the process.','assets\img\pushpaa1.png"'),
	(3,'MASTER',2021,'*7.3/10','An alcoholic professor is sent to a juvenile school, where he clashes with a gangster who uses the school children for criminal activities.','assets/img/masterr.jpg'),
  (4,'RRR',2022,'*7.9/10','A fictitious story about two legendary revolutionaries and their journey away from home before they started fighting for their country in the 1920s.','assets/img/rrrrr.jpg'),
	(5,'HIT: The First Case',2022,'*6.8/10','Vikram is a 32-year-old cop. While he is battling with his own traumatic past, the stakes get high when a girl called Preethi mysteriously disappears in Hyderabad and Vikram has to solve the case at any cost.','assets/img/hittheee.jpg');
...
VALUES
	(6,1,39,5,'This is one of my favorite movies of all time!'),
	(7,1,39,4,'On second thought, this was awful.');
